...
p = np.array([151, 160, 137, 91, 90, 15, 131, 13, 201, 95, 96, 53, 194, 233, 7, 225, 140, 36, 
...
# result = np.average(elapsed)
# print(f"Simple Perlin Noise:")
# print(f"-------------------------")
# print(f"Average elapsed time: {result}s")